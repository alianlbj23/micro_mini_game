...
from game_config import GAME_CONFIG, LEVELS, build_level_order
...
class Game:
    ...
    def draw_language_switcher(self, t):
        ...
        if zh_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0] and self.click_cooldown <= 0:
        ...
        if ja_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0] and self.click_cooldown <= 0:
    ...
    def draw_finished_screen(self, t):
        ...
        if button_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0] and self.click_cooldown <= 0:
    ...
    def draw_expression(self, level, t):
        ...
        for i in range(num_boxes):
            ...
            if i < operator_boxes:
                ...
                if op_box_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0] and self.click_cooldown <= 0:
                    if self.game_state.slots[i]:
    ...
    def draw_operator_buttons(self, level, t):
        ...
        for i, op in enumerate(OPERATORS):
            ...
            # Handle click
            if btn_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0] and not is_disabled and self.click_cooldown <= 0:
    ...
    def draw_control_buttons(self, level, t):
        ...
        if clear_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0] and is_clear_enabled and self.click_cooldown <= 0:
        ...
        if next_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0] and is_next_enabled and self.click_cooldown <= 0:
